...
public class VideoJuego_BASEX {
        ...
        try (LocalSession session = ConexionBaseX.getSession()) {
            ...
            switch (s) {
                ...
                case 5:
                    ...
                    System.out.print("Indique el id del juego a modificar: ");
                    String id_mod = lector.nextLine();

                    if (BX.cercarPerId(id_mod)) {
                        int Select;
                        modificaciones();
                        ...
                        if (Select == 1) {
                            ...
                            double nuevo_precio = lector.nextDouble();
                            BX.modificarPreu(id_mod, nuevo_precio);
                        } else if (Select == 2) {
                            System.out.println("Indique nuevo estado: ");
                            String nuevo_estado = lector.nextLine();
                            BX.modificarEstado(id_mod, nuevo_estado);
                        }
    ...
    public static void modificaciones() {
        ...
        System.out.println("2. Estado (Disponible o Agotado) ");
    }
}
